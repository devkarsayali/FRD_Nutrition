...
import { FiCheckCircle, FiClock, FiMail, FiMapPin, FiMessageSquare, FiPhone, FiSend, FiUser } from "react-icons/fi";
            ...
            {isSubmitted ? (
              <div className="p-8 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-center space-y-4 my-auto">
                ...
                <div className="space-y-1">
                  <h3 className="text-lg font-extrabold text-white">Message Received!</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      placeholder="Tell us how we can help you with your fitness goals or order inquiry..."
