...
export default function OfflineSaleBillModal({ isOpen, onClose, sale }) {
  ...
  // Printable action with dedicated A4 print layout HTML
  const handlePrint = () => {
        ...
        <head>
          ...
          <style>
            ...
            * {
            ...
            /* Customer & Transaction Side-by-side Cards */
            .details-table {
              width: 100%;
          ...
          <div class="invoice-page">
            <div>
              ...
              <table class="header-table">
                <tr>
                  <td class="logo-cell">
                    <img src="${logoImg}" alt="FRD Logo" class="logo-img" />
                  </td>
                  <td class="store-cell">
                ...
                <tr>
                  <td class="details-card">
                    ...
                    <div class="row-flex">
                      ...
                      <span class="val">${sale.customer?.name || "Walk-in Customer"}</span>
                    </div>
                    <div class="row-flex">
                      <span class="lbl">Phone Number:</span>
                      <span class="val" style="font-family: monospace;">${sale.customer?.phone && sale.customer.phone !== "N/A" ? sale.customer.phone : "N/A"}</span>
                    </div>
                  </td>
                  ...
                  <td class="details-card">
                    ...
                    <div class="row-flex">
                      ...
                      <span class="val" style="font-family: monospace;">${billNumber}</span>
                    </div>
                    <div class="row-flex">
                      <span class="lbl">Payment Method:</span>
                      <span class="val">${sale.paymentMethod || "Cash"}</span>
                    </div>
                    <div class="row-flex">
                      <span class="lbl">Payment Status:</span>
                      <span class="val paid-text">PAID</span>
                    </div>
                  </td>
                </tr>
              </table>
      ...
      return `
                        <tr>
                          ...
                          <td>
                            ...
                            <div style="font-size: 10px; color: #64748b;">${it.category || "Supplement"}</div>
                          </td>
              ...
              <div class="summary-table-wrap">
                <div class="summary-box">
                  <div class="sum-row">
                    <span>Subtotal:</span>
                    <span style="font-family: monospace; font-weight: 700; color: #0f172a;">₹${rawSubtotal}</span>
                  </div>
                  ${discount > 0 ? `
                    <div class="sum-row" style="color: #d97706; font-weight: 600;">
                  ...
                  <div class="grand-total-row">
                    ...
                    <span style="font-family: monospace; color: #65a30d;">₹${finalTotal.toLocaleString("en-IN")}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="footer-section">
              ...
              <p class="foot-note">This is an official computer-generated offline store retail receipt.</p>
            </div>
          </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-3xl bg-[#141813] border border-neutral-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 text-white my-auto max-h-[92vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between border-b border-neutral-800 pb-4">
          <div>
            <span className="text-[10px] uppercase tracking-widest font-black text-lime-400 block">
              Official POS Invoice
            </span>
            <h2 className="font-heading text-lg font-bold text-white">
              Offline Retail Sale Bill ({billNumber})
            </h2>
          </div>
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-lime-500 hover:bg-lime-400 text-neutral-950 font-black text-xs transition cursor-pointer shadow-md shadow-lime-500/20"
            >
              <FiPrinter size={15} />
              <span>Print / PDF</span>
            </button>
        ...
        <div className="bg-white text-neutral-900 p-6 sm:p-8 rounded-2xl border border-neutral-200 shadow-xl space-y-6">
          <div ref={printRef}>
            {/* Header: Store Branding & Invoice Title */}
            <div className="flex flex-col sm:flex-row items-start justify-between border-b-2 border-neutral-900 pb-5 mb-6 gap-4">
              <div className="flex items-center gap-4">
                <img
                  src={logoImg}
                  alt="FRD Nutrition Logo"
                  className="w-16 h-16 object-contain bg-neutral-950 p-1.5 rounded-xl border border-neutral-800 shrink-0"
                />
                <div>
                  <h1 className="text-xl font-extrabold text-neutral-900 tracking-tight leading-none mb-1">
                    FRD NUTRITION STORE
                  </h1>
              ...
              <div className="text-left sm:text-right shrink-0">
                <span className="inline-block px-3 py-1 bg-lime-400 text-neutral-950 font-black text-[10px] uppercase tracking-wider rounded-full shadow-sm mb-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-2">
                <span className="text-[10px] font-black uppercase tracking-wider text-slate-500 border-b border-slate-200 pb-1 block">
                  CUSTOMER DETAILS
                </span>
            ...
            <div className="flex justify-end mb-6">
              <div className="w-full sm:w-72 bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-2 text-xs">
                ...
                <div className="flex justify-between border-t-2 border-slate-900 pt-2 font-black text-sm text-slate-900">
                  <span>Grand Total:</span>
                  <span className="font-mono text-lime-600 text-lg">
            ...
            <div className="text-center border-t border-dashed border-slate-300 pt-5 space-y-2">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-50 text-emerald-700 border-2 border-emerald-600 font-black tracking-widest text-xs uppercase rounded-lg shadow-sm">
        ...
        {/* Modal Action Footer */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-neutral-800 pt-3 text-xs">
          <span className="text-neutral-400 font-medium text-center sm:text-left">
            POS Retail Bill Ready
          </span>
          <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
            <button
              onClick={handlePrint}
              className="flex-1 sm:flex-initial flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-neutral-900 border border-neutral-800 hover:bg-neutral-800 text-white font-bold transition cursor-pointer"
            >
              <FiDownload size={15} className="text-lime-400" />
              <span>Download / Print Bill</span>
            </button>
            <button
              onClick={onClose}
              className="flex-1 sm:flex-initial px-6 py-2.5 rounded-xl bg-lime-500 hover:bg-lime-400 text-neutral-950 font-black transition cursor-pointer uppercase tracking-wider text-center"
            >
              Done
            </button>
          </div>
